...
# for 2+ minutes, with no client left to notice or cancel it. web already has its own tighter 30s cap
...
# abandoned session can't hold an expensive query open indefinitely.
#
